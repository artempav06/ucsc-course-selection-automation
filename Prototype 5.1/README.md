# Prototype 4 Website - Validated Scheduler Foundation

Prototype 4 starts as a copy of Prototype 2, then adds a safer foundation for requirement and course data.

## Goal

Before adding new user-facing features, Prototype 4 focuses on schedule accuracy and maintainability:
...
- `test_export_availability.js` — export-library availability guards plus deterministic PDF/Excel/Word success-path smoke coverage.
- `test_responsive_css.js` — static responsive/mobile CSS expectations for phone breakpoints, touch targets, modal viewport containment, and discoverable schedule add-course buttons.
