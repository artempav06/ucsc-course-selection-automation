...
const GE_REQUIREMENTS = [
  {
    ...
    needed: 1,
    courses: ["ANTH 110J", "ANTH 1", "SOCY 15", "LALS 1"],
  ...
  },
  {
    ...
    needed: 1,
    courses: ["ANTH 110A", "FILM 20A", "MUSC 11A", "MUSC 11B", "MUSC 11C", "MUSC 11D", "MUSC 11E"],
    note: "One 5-credit course."
  },
  {
  ...
  },
  {
    id: "PR", name: "Practice",
    needed: 1,
    courses: ["FILM 170A", "ART 10D", "ART 10E", "ART 10F", "THEA 10", "CSE 183", "CSE 115D", "CSE 187"],
...
const CONCENTRATIONS = {
  major: {
    ...
    AM_BS: [
      ...
      { id: "am_modeling", name: "Mathematical Modeling & Dynamics", description: "Dynamical systems, fluid dynamics, chaos theory, and differential equations", courses: ["AM 107","AM 115","MATH 106","MATH 107","MATH 145"] },
    ...
    TIM_BS: [
      { id: "tim_entrepreneurship", name: "Tech Entrepreneurship", description: "Startup creation, product management, and business strategy", courses: ["ECON 166A","ECON 135","ECON 136"] },
      ...
      { id: "tim_finance_econ", name: "Finance & Economics", description: "Financial mathematics, econometrics, and economic policy", courses: ["ECON 100B","ECON 101","ECON 104","ECON 110","ECON 111A","ECON 111B","ECON 114","ECON 115","ECON 120","ECON 128"] }
    ]
  },
  ge: [
    ...
    { id: "ge_creative", name: "Creative Expression", description: "Studio art, performance, creative writing, filmmaking", geCodes: ["PR-C","PR-E"], courses: ["ART 10D","ART 10E","ART 10F","THEA 10","LIT 90","LIT 61L","FILM 20A","CMPM 17","MUSC 80A","MATH 50","WRIT 30","CMPM 80J"] },
