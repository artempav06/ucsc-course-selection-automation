# Prototype 4 Current Data Model

Prototype 4 starts as a safe copy of Prototype 2. The first foundation goal is not to rewrite the scheduler; it is to make the existing data shapes explicit, validated, and ready for gradual normalization.
...
The initial Prototype 4 validator should be conservative:
